...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "index", "class": "astro-J7PV25F6" }, { "default": ($$result2) => renderTemplate`${maybeRenderHead($$result2)}<main class="main astro-J7PV25F6">
		...
		${renderComponent($$result2, "Shortbio", $$Shortbio, { "id": "shortbio", "ownClass": "h-[330vh] sm:h-[430vh]", "class": "astro-J7PV25F6" }, { "default": ($$result3) => renderTemplate`<div id="bio-title-container" class="w-full h-screen relative astro-J7PV25F6">
		...
		${renderComponent($$result2, "Portfolio", $$Portfolio, { "class": "astro-J7PV25F6" }, { "default": ($$result3) => renderTemplate`<div id="projects-title-container" class="w-full h-16 sm:h-[25vh] relative astro-J7PV25F6">
			${renderComponent($$result3, "Title", $$Title, { "id": "projects-title", "title": "Projects", "preTitle": "richi", "titleClass": "absolute top-0 text-6xl sm:text-9xl", "class": "astro-J7PV25F6" })}
