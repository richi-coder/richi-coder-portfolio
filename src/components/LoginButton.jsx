...
function LoginButton() {
    ...
    useEffect(() => {
        setLadder1('ladderAnim')
        setTimeout(() => {
            setLadder2('ladderAnim')
            setTimeout(() => {
                setLadder3('ladderAnim')
            }, 500);
        }, 500);
    }, [])
  ...
  return (
    <div className='text-2xl md:text-3xl flex-grow lg:flex-grow-0 flex flex-col lg:flex-row items-center justify-around lg:justify-center lg:gap-[7vw] w-2/3 md:w-full lg:pt-28 select-none'>
        <button
        onClick={googleLogin}
